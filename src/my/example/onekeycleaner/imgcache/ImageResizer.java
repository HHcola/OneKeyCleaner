...
public class ImageResizer extends ImageWorker {
	...
	protected Bitmap processBitmap(Object... data) {
		return processBitmap(Integer.parseInt(String.valueOf(data[0])));
	}
	...
	public static Bitmap decodeSampledBitmapFromResource(Resources res,
		...
		/*
		 * if(bitmap != null) { int width = bitmap.getWidth(); int height =
		 * bitmap.getHeight();
		 * 
		 * if(width > height) { Matrix matrix = new Matrix();
		 * matrix.postRotate(90); bitmap = Bitmap.createBitmap(bitmap, 0, 0,
	...
	public static Bitmap decodeSampledBitmapFromDescriptor(
			...
			ImageCache cache, boolean isRotate) {
		// First decode with inJustDecodeBounds=true to check dimensions
		final BitmapFactory.Options options = new BitmapFactory.Options();
		options.inJustDecodeBounds = true;
