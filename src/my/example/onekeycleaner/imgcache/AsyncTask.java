 ...
 */
//解决图片缓存下载线程过多 抛出这个RejectedExecutionException异常
public abstract class AsyncTask<Params, Progress, Result> {
    private static final String LOG_TAG = "AsyncTask #2 ";
    ...
    private static final ThreadFactory  sThreadFactory = new ThreadFactory() {
        ...
        public Thread newThread(Runnable r) {
            return new Thread(r, "AsyncTask ImageFetcher #" + mCount.getAndIncrement());
        }
    };
    ...
    public static final Executor DUAL_THREAD_EXECUTOR =
            Executors.newFixedThreadPool(CORE_POOL_SIZE, sThreadFactory);
